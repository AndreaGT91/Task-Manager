# Task-Manager
Simple app that helps you keep a running to-do list. User can enter a description of the task that needs to be done. Unfinished tasks will display on the left side of the page, waiting to be completed. Completed tasks will display on the right side of the page. Each uncompleted task has a `Completed` button, and all tasks have a `Delete` button. The app will store every task in a database. App utilizes MySQL, Node, Express, Handlebars, ORM and the MVC design pattern.

The original homework assignment, described below, involved devouring burgers. Since this did not seem to be a very useful app, it was converted to a task management app.

## GitHub Repository
[github.com/AndreaGT91/Burger](https://github.com/AndreaGT91/Task-Manager)

## Heroku Deployment
[aqueous-river-75295.herokuapp.com](https://aqueous-river-75295.herokuapp.com)
